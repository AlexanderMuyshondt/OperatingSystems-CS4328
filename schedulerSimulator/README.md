...
`$ git clone https://github.com/AlexanderMuyshondt/SchedulerSimulator`
...
## Report
I have written a short report detailing my observations based on the output of my code and the graphs I 
have generated.
